...
to setup
  ...
  create-a-plant "a" "a"  -.25  .25
  create-a-plant "b" "b"  .25  .25
  create-a-plant "c" "a"  .25  -.25
  create-a-plant "d" "b"  -.25  -.25
  
  let gl []
  ask one-of plants with [ grph = "a" ] [ set gl goal-list  ]
  setup-graph-for "a" min-pxcor - .2 max-pycor - .2 gl
  
  ask one-of plants with [ grph = "b" ] [ set gl goal-list  ]
  setup-graph-for "b" max-pxcor - .2 max-pycor - .2 gl
  
  ask one-of plants with [ grph = "c" ] [ set gl goal-list  ]  
  setup-graph-for "c" max-pxcor - .2 min-pycor - .2 gl
  
  ask one-of plants with [ grph = "d" ] [ set gl goal-list  ]  
  setup-graph-for "d" min-pxcor - .2 min-pycor - .2 gl 
...
to spend-resources [resource-units]
  set water-resources water-resources - resource-units
  set sun-resources sun-resources - resource-units
  repeat resource-units [
...
to create-a-plant [ pos ptype xc yc  ]
